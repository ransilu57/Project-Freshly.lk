        ...
        <div className="relative px-6 py-16 sm:px-12 lg:px-16">
          ...
          <div className="relative text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {/* Added Creative Login Button */}
              <button className="flex items-center justify-center gap-2 bg-emerald-800 text-white hover:bg-emerald-700 px-8 py-3 rounded-lg font-medium shadow-lg transition-all duration-300 group">
